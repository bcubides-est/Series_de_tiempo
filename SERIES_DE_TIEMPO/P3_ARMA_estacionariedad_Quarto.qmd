...
Para un proceso AR(2) con polinomio \[ \phi(z) = 1 - 0.2,z - 0.48,z\^2, \] calculamos sus raíces y verificamos la condición de causalidad (todas las raíces fuera del círculo unitario, (\|z_i\|\>1)).
...
Punteros del polinomio: \[ \phi(z) = 1 + 1.5,z - 0.75,z\^2. \]
